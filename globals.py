import os
from secret import (NOTION_API_TOKEN, NOTION_DATABASE_ID, PAGES_CSV_FILE_NAME,
...
TASK_COMPLETION_TIMES_PLOT_PATH = os.path.join(ANALYSIS_DIR, "task_completion_times.png")
